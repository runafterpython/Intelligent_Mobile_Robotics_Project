...
# Initialize A* planner and find path
planner = AStarPlanner(env, grid_resolution=0.5)
...
# Generate and plot trajectory following the discrete path
if path is not None:
    try:
        traj_gen = PolynomialTrajectoryGenerator(nominal_speed=1.0, min_dt=0.5)
        traj_gen.generate_and_plot(path, sample_dt=0.02)
    except Exception as e:
        print("Trajectory generation failed:", e)
